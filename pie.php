		...
		<div class="container text-center">
			<div class="row">
				...
				<div class="col-lg-2 col-md-2 col-xs-12 col-sm-12" style="margin-top:1%">
					<img src="http://www.maradentro.com.co/img/logo.png" width="100%" />
				</div>
							...
							<ul class="nav navbar-nav navbar-left clasMenPie">
							    <li class="dropdown">
							        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
							          	...
							          	<ul class="dropdown-menu">
									        <li><a style="color:#005b84" href="http://www.maradentro.com.co/proyectos/neiva">NEIVA</a></li>
									        <li><a style="color:#005b84" href="#">FLANDES </a></li>
									        <li><a style="color:#005b84" href="http://www.maradentro.com.co/proyectos/cartagena">CARTAGENA </a></li>
			        					</ul>
							        </a>
						        </li>
							    ...
							    <li class="dropdown">
							        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
							          	...
							          	<ul class="dropdown-menu">
									        <li><a style="color:#005b84" href="http://www.maradentro.com.co/amenities/neiva">NEIVA</a></li>
									        <li><a style="color:#005b84" href="#">FLANDES </a></li>
