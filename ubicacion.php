...
<html>
	<head>
		<title>Mar Adentro - Ubicación</title>
	...
	<div class="container-fluid bgUbi">
		<div class="container text-center colorMsgCenter">
			<h1>Un Lugar exclusivo para Mar Adentro al sur de Neiva</h1>
		</div>
	</div>
		...
		<div class="container text-center">
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
					<h2 class="tituloSeccion text-center">NUESTRA UBICACIÓN</h2>
					<p class="pInternas2">
					Ubicado en el sur de la ciudad, zona de gran desarrollo, sobre la avenida al  Caguán este proyecto está pensado inicialmente con áreas entre los 50 y los 64 m2 con acabados y precios desde los 103 millones de pesos. La Sala de Ventas se encuentra ubicada en la <strong>Ciudadela NIO</strong>.
					</p>
				</div>
				<div class="col-lg-2 col-md-2 col-xs-12 col-sm-12 visible-lg visible-md"></div>
			</div>
